...
ln -s ../$sram_name/NLDM/${sram_name}_${sram_corner}.lib outputs/sram_small_tt.lib
ln -s ../$sram_name/GDSII/${sram_name}_m4xdh.gds outputs/sram_small.gds
ln -s ../$sram_name/LEF/${sram_name}_m4xdh.lef outputs/sram_small.lef
ln -s ../$sram_name/VERILOG/${sram_name}_pwr.v outputs/sram_small_pwr.v
ln -s ../$sram_name/VERILOG/${sram_name}.v outputs/sram_small.v
ln -s ../$sram_name/SPICE/${sram_name}.spi outputs/sram_small.spi
