...
### Floor Plan #
################
set FP_width $Dcell_inv_inv_width
set FP_height $Dcell_inv_inv_height
...
# pre placement #
#################
placeInstance Itri_inv_merged [expr ($FP_width-$tri_inv_merged_width)/2] 0 
placeInstance Inand [expr $FP_width/2] $cell_height
...
# Load IO file #
##--------------------------------------------
#loadIoFile ${ioDir}/Dcell_nand_inv.io
...
assignIoPins -pin {slow rstb init_pulse init}

editPin -pinWidth $pin_width -pinDepth $pin_depth -fixOverlap 1 -unit MICRON -spreadDirection clockwise -edge 2 -layer 2 -spreadType start -spacing [expr 3*$metal_space] -offsetStart 0.1 -pin {rstb slow init_pulse init}

assignIoPins -pin {IN1 OUT}

editPin -pinWidth $pin_width -pinDepth $pin_depth -fixOverlap 0 -unit MICRON -spreadDirection counterclockwise -edge 3 -layer 3 -spreadType start -spacing 0 -offsetStart [expr $FP_width/2] -pin {IN1}
