...
sroute -connect { blockPin } -inst {idcore_out_buff_i} -layerChangeRange { M7 M7 } -blockPinTarget { boundaryWithPin } -allowJogging 1 -crossoverViaLayerRange { M8 M1 } -nets {DVDD DVSS} -allowLayerChange 0 -blockPin useLef -targetViaLayerRange { M8 M1 }
...
set out_pin_x [get_property [get_pins idcore_out_buff_i/clock_out_p] x_coordinate] 
set clock_out_p_pin_y [get_property [get_pins idcore_out_buff_i/clock_out_p] y_coordinate] 
set clock_out_n_pin_y [get_property [get_pins idcore_out_buff_i/clock_out_n] y_coordinate] 
set trigg_out_p_pin_y [get_property [get_pins idcore_out_buff_i/trigg_out_p] y_coordinate] 
set trigg_out_n_pin_y [get_property [get_pins idcore_out_buff_i/trigg_out_n] y_coordinate] 
