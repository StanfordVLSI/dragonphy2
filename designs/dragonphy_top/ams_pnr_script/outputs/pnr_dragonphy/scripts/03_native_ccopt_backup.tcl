...
#  set_ccopt_property sink_type -pin {iV2Tp_dont_touch/clk_v2t_e} exclude 
#  set_ccopt_property sink_type -pin {iV2Tp_dont_touch/clk_v2t_eb} exclude 
#  set_ccopt_property sink_type -pin {iV2Tn_dont_touch/clk_v2t_e} exclude
#  set_ccopt_property sink_type -pin {iV2Tn_dont_touch/clk_v2t_eb} exclude 
