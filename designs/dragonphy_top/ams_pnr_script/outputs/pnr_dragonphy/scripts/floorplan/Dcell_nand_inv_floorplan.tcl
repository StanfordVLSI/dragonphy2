...
# pre placement #
#################
placeInstance Inand [expr $FP_width/2] 0
placeInstance Itri_inv_merged [expr ($FP_width-$tri_inv_merged_width)/2] [expr $cell_height] MY
...
# Load IO file #
##--------------------------------------------
#loadIoFile ${ioDir}/Dcell_inv_inv.io
