...
create_clock -name clk_TDC [get_pins idcdl_coarse_dont_touch/out]  -period $CLK_DIV_PERIOD
set_clock_uncertainty 0.01  [get_clocks clk_TDC]

create_clock -name clk_pm -period $CLK_DIV_PERIOD [get_pins iPM/iPM_sub_dont_touch/uBD1/Z]  
...
set_false_path -to [get_pins iPM/iPM_sub_dont_touch/ff_*_reg/CP] 
