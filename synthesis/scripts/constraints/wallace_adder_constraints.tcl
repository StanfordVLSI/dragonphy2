...
# Clocks
#########
set CLK_ADDER 0.5 ; # mdll output clock period

create_clock -name clk -period $CLK_ADDER [get_nets clk] ; # mdllout
...
set_max_transition 0.05 -clock_path clk
...
# DONT USE CELLS
# define dont use cells (e.g. weak cells)
