...
create_clock -name clk_encoder -period [expr ${CLK_DIV_PERIOD}*0.8] [get_ports clk_encoder]
set_clock_uncertainty 0.01 clk_encoder
...
set_clock_groups -asynchronous -group clk_encoder -group clk_async
set_clock_groups -asynchronous -group clk_pm -group clk_async

set_clock_groups -asynchronous -group clk_in -group clk_bld
set_clock_groups -asynchronous -group clk_encoder -group clk_bld
set_clock_groups -asynchronous -group clk_pm -group clk_bld

set_clock_groups -asynchronous -group clk_in -group clk_encoder
set_clock_groups -asynchronous -group clk_pm -group clk_encoder
