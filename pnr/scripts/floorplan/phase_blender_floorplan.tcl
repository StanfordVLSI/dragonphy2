...
#---------------------------------------------------------
set mux_blender_area [get_property [get_cells imux_bld_dont_touch_0_] area]
set mux_blender_width [expr round($mux_blender_area/$cell_height/$cell_grid)*$cell_grid]

set inbuf1_area [get_property [get_cells iin_buf_odd1_dont_touch] area]
set inbuf1_width [expr round($inbuf1_area/$cell_height/$cell_grid)*$cell_grid]
set inbuf2_area [get_property [get_cells iin_buf_odd2_dont_touch] area]
set inbuf2_width [expr round($inbuf2_area/$cell_height/$cell_grid)*$cell_grid]
set outbuf1_area [get_property [get_cells iout_buf1_dont_touch] area]
set outbuf1_width [expr round($outbuf1_area/$cell_height/$cell_grid)*$cell_grid]
set outbuf2_area [get_property [get_cells iout_buf2_dont_touch] area]
...
placeInstance iin_buf_even1_dont_touch/U1 [expr $boundary_width] [expr $boundary_height+4*$cell_height]
placeInstance iin_buf_even2_dont_touch/U1 [expr $boundary_width+$inbuf1_width] [expr $boundary_height+4*$cell_height] 
placeInstance iin_buf_odd1_dont_touch/U1 [expr $boundary_width] [expr $boundary_height+11*$cell_height] 
placeInstance iin_buf_odd2_dont_touch/U1 [expr $boundary_width+$inbuf1_width] [expr $boundary_height+11*$cell_height]

for { set k 0} {$k < $blender_Nunit} {incr k} {
	placeInstance imux_bld_dont_touch_${k}_/U1 [expr $boundary_width+$inbuf1_width+$inbuf2_width] [expr $boundary_height+$k*$cell_height]
}

placeInstance iout_buf1_dont_touch/U1  [expr $boundary_width+$inbuf1_width+$inbuf2_width+$mux_blender_width] [expr $boundary_height+7*$cell_height]
placeInstance iout_buf2_dont_touch/U1 [expr $boundary_width+$inbuf1_width+$inbuf2_width+$mux_blender_width] [expr $boundary_height+8*$cell_height] 
...
set ph_in0_offset [get_property [get_pins iin_buf_odd1_dont_touch/U1/I] y_coordinate]
set ph_in1_offset [get_property [get_pins iin_buf_even1_dont_touch/U1//I] y_coordinate]
