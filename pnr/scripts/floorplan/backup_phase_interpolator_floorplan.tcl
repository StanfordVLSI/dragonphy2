...
set routing_space0 [expr ceil((10)/$cell_grid)*$cell_grid]
set routing_space1 [expr ceil((2.5)/$cell_grid)*$cell_grid]
...
for { set k 0} {$k < [expr $delay_Nunit/8]} {incr k} {
	placeInstance imux_network/imux4_gf_1st_$k\__odd/imux4_dont_touch/IMUX4 [expr $origin1_x+$PI_delay_unit_width+$routing_space1] [expr $origin1_y+($delay_Nunit/8+$k*$delay_Nunit/4)*$PI_delay_unit_height+2*$cell_height]
	createPlaceBlockage -box [expr $origin1_x+$PI_delay_unit_width+$routing_space1] [expr $origin1_y+($delay_Nunit/8+$k*$delay_Nunit/4)*$PI_delay_unit_height+2*$cell_height-$cell_height] [expr $origin1_x+$PI_delay_unit_width+$routing_space1+$mux4_width] [expr $origin1_y+($delay_Nunit/8+$k*$delay_Nunit/4)*$PI_delay_unit_height+2*$cell_height+2*$cell_height] -type hard
	
	placeInstance imux_network/imux4_gf_1st_$k\__even/imux4_dont_touch/IMUX4 [expr $origin1_x+$PI_delay_unit_width+$routing_space1_1] [expr $origin1_y+($delay_Nunit/8+$k*$delay_Nunit/4)*$PI_delay_unit_height-$cell_height-2*$cell_height]
	createPlaceBlockage -box [expr $origin1_x+$PI_delay_unit_width+$routing_space1_1] [expr $origin1_y+($delay_Nunit/8+$k*$delay_Nunit/4)*$PI_delay_unit_height-$cell_height-2*$cell_height-$cell_height]  [expr $origin1_x+$PI_delay_unit_width+$routing_space1_1+$mux4_width] [expr $origin1_y+($delay_Nunit/8+$k*$delay_Nunit/4)*$PI_delay_unit_height-$cell_height-2*$cell_height+2*$cell_height] -type hard 
}
#(mux 2nd stage)
placeInstance imux_network/imux4_gf_2nd_odd/imux4_dont_touch/IMUX4 [expr $origin1_x+$PI_delay_unit_width+$routing_space1+$mux4_width+$routing_space2_1] [expr $origin1_y+($delay_Nunit/2)*$PI_delay_unit_height+$cell_height]
placeInstance imux_network/imux4_gf_2nd_even/imux4_dont_touch/IMUX4 [expr $origin1_x+$PI_delay_unit_width+$routing_space1+$mux4_width+$routing_space2] [expr $origin1_y+($delay_Nunit/2)*$PI_delay_unit_height-$cell_height-$cell_height]

#[phase_blender]
#(blender_inbuf)
placeInstance iphase_blender_dont_touch/iin_buf_odd1_dont_touch/U1  [expr $origin1_x+$PI_delay_unit_width+$routing_space1+$routing_space2+2*$mux4_width] [expr $origin1_y+$PI_delay_unit_height*$delay_Nunit/2-($blender_Nunit/4+1)*$cell_height]
placeInstance iphase_blender_dont_touch/iin_buf_odd2_dont_touch/U1 [expr $origin1_x+$PI_delay_unit_width+$routing_space1+$routing_space2+2*$mux4_width+$inbuf1_width] [expr $origin1_y+$PI_delay_unit_height*$delay_Nunit/2-($blender_Nunit/4+1)*$cell_height]

placeInstance iphase_blender_dont_touch/iin_buf_even1_dont_touch/U1  [expr $origin1_x+$PI_delay_unit_width+$routing_space1+$routing_space2+2*$mux4_width] [expr $origin1_y+$PI_delay_unit_height*$delay_Nunit/2+($blender_Nunit/4)*$cell_height]
placeInstance iphase_blender_dont_touch/iin_buf_even2_dont_touch/U1 [expr $origin1_x+$PI_delay_unit_width+$routing_space1+$routing_space2+2*$mux4_width+$inbuf1_width] [expr $origin1_y+$PI_delay_unit_height*$delay_Nunit/2+($blender_Nunit/4)*$cell_height]
#(blender_mux_array)
