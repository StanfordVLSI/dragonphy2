...
def plot_histogram(ffe_out, ideal_in, delay_ffe=0, delay_ideal=0, n_bits=1, bins=50, plt_show=True, save_dir=None):
...
def test_fir():
    ...
    plot_histogram(single_matrix[2:-1], ideal_codes) 
