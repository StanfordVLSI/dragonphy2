...
inv_4_fixed iinv_clk_divb_dont_touch (.in(clk_div), .out(clk_divb));
...
n_or_fixed in_or1_dont_touch(.in1(clk_divb), .in2(clk_div_sampled), .out(nor_out1));
n_or_fixed in_or2_dont_touch(.in1(clk_divb), .in2(clk_div_sampled_d), .out(nor_out2));
n_or_fixed in_or3_dont_touch(.in1(clk_divb), .in2(clk_div_sampled_dd), .out(nor_out3));
