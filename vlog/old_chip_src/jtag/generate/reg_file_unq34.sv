...
//	[ { Default=>0, IEO=>o, Name=>init_rep_0, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_rep_1, Width=>2 }
//	]
//
...
//
// REGISTERS
// init_rep_0 [1:0] IEO=o Offset=0 -- 
// init_rep_1 [1:0] IEO=o Offset=4 -- 
...
module reg_file_unq34
  (
   ...
   //outputs
    // outputs for register init_rep_0
    output wire logic[1:0]       init_rep_0_q,
                           
    // outputs for register init_rep_1
    output wire logic[1:0]       init_rep_1_q,
   ...
   assign addr_in_range = ((11'h420 == cfgIn_addr_del[13:3]) &&
