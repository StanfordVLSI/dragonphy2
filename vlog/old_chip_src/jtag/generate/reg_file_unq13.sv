...
//	[ { IEO=>i, Name=>adcout_sum_rep_0, Width=>24 },
//	  { IEO=>i, Name=>adcout_sum_rep_1, Width=>24 }
//	]
//
...
//
// REGISTERS
// adcout_sum_rep_0 [23:0] IEO=i Offset=0 -- 
// adcout_sum_rep_1 [23:0] IEO=i Offset=4 -- 
...
//                             MODULE:
// =============================================================================
module reg_file_unq13
  (
   // inputs for the config interface
   cfg_ifc_unq1.cfgIn cfgIn, // incoming requests
   cfg_ifc_unq1.cfgOut cfgOut, // outgoing responds

    // inputs for register adcout_sum_rep_0
    input wire logic [23:0]       adcout_sum_rep_0_d,

    // inputs for register adcout_sum_rep_1
    input wire logic [23:0]       adcout_sum_rep_1_d,
   ...
   assign addr_in_range = ((11'h3a0 == cfgIn_addr_del[13:3]) &&
   ...
   // ==============================
   // register #0 --- name:adcout_sum_rep_0, type:i, Width:24
   ...
   assign regs_d[0][23:0] = (onehot_en[0])?cfgIn_data_del[23:0]:
                                                                  adcout_sum_rep_0_d[23:0]; 
   flop_unq11  adcout_sum_rep_0_reg
   ...
   // register #1 --- name:adcout_sum_rep_1, type:i, Width:24
   // flop input with no qualifier
   assign regs_en[1] = 1'b1; 
   // give priority to cfg bus writes, otherwise input from module input
   assign regs_d[1][23:0] = (onehot_en[1])?cfgIn_data_del[23:0]:
                                                                  adcout_sum_rep_1_d[23:0]; 
   flop_unq11  adcout_sum_rep_1_reg
