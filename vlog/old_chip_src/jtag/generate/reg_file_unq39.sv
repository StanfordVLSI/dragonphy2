...
//	[ { Default=>0, IEO=>o, Name=>ctl_dcdl_TDC_rep_0, Width=>5 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_TDC_rep_1, Width=>5 }
//	]
//
// BaseAddr (_GENESIS2_INHERITANCE_PRIORITY_) = 0x2600
//
...
//
// REGISTERS
// ctl_dcdl_TDC_rep_0 [4:0] IEO=o Offset=0 -- 
// ctl_dcdl_TDC_rep_1 [4:0] IEO=o Offset=4 -- 
...
module reg_file_unq39
  (
   ...
   //outputs
    // outputs for register ctl_dcdl_TDC_rep_0
    output wire logic[4:0]       ctl_dcdl_TDC_rep_0_q,
                           
    // outputs for register ctl_dcdl_TDC_rep_1
    output wire logic[4:0]       ctl_dcdl_TDC_rep_1_q,
   ...
   assign addr_in_range = ((11'h4c0 == cfgIn_addr_del[13:3]) &&
