...
//	[ { IEO=>i, Name=>max_sel_mux_0, Width=>5 },
//	  { IEO=>i, Name=>max_sel_mux_1, Width=>5 },
//	  { IEO=>i, Name=>max_sel_mux_2, Width=>5 },
//	  { IEO=>i, Name=>max_sel_mux_3, Width=>5 }
//	]
//
...
//
// REGISTERS
// max_sel_mux_0 [4:0] IEO=i Offset=0 -- 
// max_sel_mux_1 [4:0] IEO=i Offset=4 -- 
// max_sel_mux_2 [4:0] IEO=i Offset=8 -- 
// max_sel_mux_3 [4:0] IEO=i Offset=12 -- 
...
//                             MODULE:
// =============================================================================
module reg_file_unq5
  (
   // inputs for the config interface
   cfg_ifc_unq1.cfgIn cfgIn, // incoming requests
   cfg_ifc_unq1.cfgOut cfgOut, // outgoing responds

    // inputs for register max_sel_mux_0
    input wire logic [4:0]       max_sel_mux_0_d,

    // inputs for register max_sel_mux_1
    input wire logic [4:0]       max_sel_mux_1_d,

    // inputs for register max_sel_mux_2
    input wire logic [4:0]       max_sel_mux_2_d,

    // inputs for register max_sel_mux_3
    input wire logic [4:0]       max_sel_mux_3_d,
   ...
   assign addr_in_range = ((10'h150 == cfgIn_addr_del[13:4]) &&
   ...
   // ==============================
   // register #0 --- name:max_sel_mux_0, type:i, Width:5
   // flop input with no qualifier
   assign regs_en[0] = 1'b1; 
   // give priority to cfg bus writes, otherwise input from module input
   assign regs_d[0][4:0] = (onehot_en[0])?cfgIn_data_del[4:0]:
                                                                  max_sel_mux_0_d[4:0]; 
   flop_unq9  max_sel_mux_0_reg
   ...
   // register #1 --- name:max_sel_mux_1, type:i, Width:5
   // flop input with no qualifier
   assign regs_en[1] = 1'b1; 
   // give priority to cfg bus writes, otherwise input from module input
   assign regs_d[1][4:0] = (onehot_en[1])?cfgIn_data_del[4:0]:
                                                                  max_sel_mux_1_d[4:0]; 
   flop_unq9  max_sel_mux_1_reg
   ...
   // register #2 --- name:max_sel_mux_2, type:i, Width:5
   // flop input with no qualifier
   assign regs_en[2] = 1'b1; 
   // give priority to cfg bus writes, otherwise input from module input
   assign regs_d[2][4:0] = (onehot_en[2])?cfgIn_data_del[4:0]:
                                                                  max_sel_mux_2_d[4:0]; 
   flop_unq9  max_sel_mux_2_reg
   ...
   // register #3 --- name:max_sel_mux_3, type:i, Width:5
   // flop input with no qualifier
   assign regs_en[3] = 1'b1; 
   // give priority to cfg bus writes, otherwise input from module input
   assign regs_d[3][4:0] = (onehot_en[3])?cfgIn_data_del[4:0]:
                                                                  max_sel_mux_3_d[4:0]; 
   flop_unq9  max_sel_mux_3_reg
