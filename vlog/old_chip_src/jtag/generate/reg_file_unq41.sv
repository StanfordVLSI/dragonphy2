...
//	[ { Default=>0, IEO=>o, Name=>ext_pi_ctl_offset_0, Width=>9 },
//	  { Default=>0x87, IEO=>o, Name=>ext_pi_ctl_offset_1, Width=>9 },
//	  { Default=>0x10e, IEO=>o, Name=>ext_pi_ctl_offset_2, Width=>9 },
//	  { Default=>0x195, IEO=>o, Name=>ext_pi_ctl_offset_3, Width=>9 }
//	]
//
// BaseAddr (_GENESIS2_INHERITANCE_PRIORITY_) = 0x2800
//
...
//
// REGISTERS
// ext_pi_ctl_offset_0 [8:0] IEO=o Offset=0 -- 
// ext_pi_ctl_offset_1 [8:0] IEO=o Offset=4 -- 
// ext_pi_ctl_offset_2 [8:0] IEO=o Offset=8 -- 
// ext_pi_ctl_offset_3 [8:0] IEO=o Offset=12 -- 
...
module reg_file_unq41
  (
   ...
   //outputs
    // outputs for register ext_pi_ctl_offset_0
    output wire logic[8:0]       ext_pi_ctl_offset_0_q,
                           
    // outputs for register ext_pi_ctl_offset_1
    output wire logic[8:0]       ext_pi_ctl_offset_1_q,
                           
    // outputs for register ext_pi_ctl_offset_2
    output wire logic[8:0]       ext_pi_ctl_offset_2_q,
                           
    // outputs for register ext_pi_ctl_offset_3
    output wire logic[8:0]       ext_pi_ctl_offset_3_q,
   ...
   assign addr_in_range = ((10'h280 == cfgIn_addr_del[13:4]) &&
   ...
   // ==============================
   // register #0 --- name:ext_pi_ctl_offset_0, type:o, Width:9
   // flop input only on cfg writes
   assign regs_en[0] = onehot_en[0]; 
   // input only from cfg bus
   assign regs_d[0][8:0] = cfgIn_data_del[8:0]; 
   flop_unq30  ext_pi_ctl_offset_0_reg
     (.Clk(Clk), .Reset(Reset), .en(regs_en[0]),
      .din(regs_d[0][8:0]), .dout(regs_q[0][8:0]));

   // assign value to the relevant output
   assign ext_pi_ctl_offset_0_q[8:0] = regs_q[0][8:0]; 
   // pad the config bus with zeros
   assign regs_q[0][31:9] = '0; 
   
   // register #1 --- name:ext_pi_ctl_offset_1, type:o, Width:9
   // flop input only on cfg writes
   assign regs_en[1] = onehot_en[1]; 
   // input only from cfg bus
   assign regs_d[1][8:0] = cfgIn_data_del[8:0]; 
   flop_unq31  ext_pi_ctl_offset_1_reg
     (.Clk(Clk), .Reset(Reset), .en(regs_en[1]),
      .din(regs_d[1][8:0]), .dout(regs_q[1][8:0]));

   // assign value to the relevant output
   assign ext_pi_ctl_offset_1_q[8:0] = regs_q[1][8:0]; 
   // pad the config bus with zeros
   assign regs_q[1][31:9] = '0; 
   
   // register #2 --- name:ext_pi_ctl_offset_2, type:o, Width:9
   // flop input only on cfg writes
   assign regs_en[2] = onehot_en[2]; 
   // input only from cfg bus
   assign regs_d[2][8:0] = cfgIn_data_del[8:0]; 
   flop_unq32  ext_pi_ctl_offset_2_reg
     (.Clk(Clk), .Reset(Reset), .en(regs_en[2]),
      .din(regs_d[2][8:0]), .dout(regs_q[2][8:0]));

   // assign value to the relevant output
   assign ext_pi_ctl_offset_2_q[8:0] = regs_q[2][8:0]; 
   // pad the config bus with zeros
   assign regs_q[2][31:9] = '0; 
   
   // register #3 --- name:ext_pi_ctl_offset_3, type:o, Width:9
   // flop input only on cfg writes
   assign regs_en[3] = onehot_en[3]; 
   // input only from cfg bus
   assign regs_d[3][8:0] = cfgIn_data_del[8:0]; 
   flop_unq33  ext_pi_ctl_offset_3_reg
     (.Clk(Clk), .Reset(Reset), .en(regs_en[3]),
      .din(regs_d[3][8:0]), .dout(regs_q[3][8:0]));

   // assign value to the relevant output
   assign ext_pi_ctl_offset_3_q[8:0] = regs_q[3][8:0]; 
   // pad the config bus with zeros
   assign regs_q[3][31:9] = '0; 
   
endmodule: reg_file_unq41
