...
//	[ { Default=>0, IEO=>o, Name=>ctl_dcdl_early_0, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_1, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_2, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_3, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_4, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_5, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_6, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_7, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_8, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_9, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_10, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_11, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_12, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_13, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_14, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_early_15, Width=>2 }
//	]
//
...
//
// REGISTERS
// ctl_dcdl_early_0 [1:0] IEO=o Offset=0 -- 
// ctl_dcdl_early_1 [1:0] IEO=o Offset=4 -- 
// ctl_dcdl_early_2 [1:0] IEO=o Offset=8 -- 
// ctl_dcdl_early_3 [1:0] IEO=o Offset=12 -- 
// ctl_dcdl_early_4 [1:0] IEO=o Offset=16 -- 
// ctl_dcdl_early_5 [1:0] IEO=o Offset=20 -- 
// ctl_dcdl_early_6 [1:0] IEO=o Offset=24 -- 
// ctl_dcdl_early_7 [1:0] IEO=o Offset=28 -- 
// ctl_dcdl_early_8 [1:0] IEO=o Offset=32 -- 
// ctl_dcdl_early_9 [1:0] IEO=o Offset=36 -- 
// ctl_dcdl_early_10 [1:0] IEO=o Offset=40 -- 
// ctl_dcdl_early_11 [1:0] IEO=o Offset=44 -- 
// ctl_dcdl_early_12 [1:0] IEO=o Offset=48 -- 
// ctl_dcdl_early_13 [1:0] IEO=o Offset=52 -- 
// ctl_dcdl_early_14 [1:0] IEO=o Offset=56 -- 
// ctl_dcdl_early_15 [1:0] IEO=o Offset=60 -- 
...
module reg_file_unq25
  (
   ...
   //outputs
    // outputs for register ctl_dcdl_early_0
    output wire logic[1:0]       ctl_dcdl_early_0_q,
                           
    // outputs for register ctl_dcdl_early_1
    output wire logic[1:0]       ctl_dcdl_early_1_q,
                           
    // outputs for register ctl_dcdl_early_2
    output wire logic[1:0]       ctl_dcdl_early_2_q,
                           
    // outputs for register ctl_dcdl_early_3
    output wire logic[1:0]       ctl_dcdl_early_3_q,
                           
    // outputs for register ctl_dcdl_early_4
    output wire logic[1:0]       ctl_dcdl_early_4_q,
                           
    // outputs for register ctl_dcdl_early_5
    output wire logic[1:0]       ctl_dcdl_early_5_q,
                           
    // outputs for register ctl_dcdl_early_6
    output wire logic[1:0]       ctl_dcdl_early_6_q,
                           
    // outputs for register ctl_dcdl_early_7
    output wire logic[1:0]       ctl_dcdl_early_7_q,
                           
    // outputs for register ctl_dcdl_early_8
    output wire logic[1:0]       ctl_dcdl_early_8_q,
                           
    // outputs for register ctl_dcdl_early_9
    output wire logic[1:0]       ctl_dcdl_early_9_q,
                           
    // outputs for register ctl_dcdl_early_10
    output wire logic[1:0]       ctl_dcdl_early_10_q,
                           
    // outputs for register ctl_dcdl_early_11
    output wire logic[1:0]       ctl_dcdl_early_11_q,
                           
    // outputs for register ctl_dcdl_early_12
    output wire logic[1:0]       ctl_dcdl_early_12_q,
                           
    // outputs for register ctl_dcdl_early_13
    output wire logic[1:0]       ctl_dcdl_early_13_q,
                           
    // outputs for register ctl_dcdl_early_14
    output wire logic[1:0]       ctl_dcdl_early_14_q,
                           
    // outputs for register ctl_dcdl_early_15
    output wire logic[1:0]       ctl_dcdl_early_15_q,
