...
//	[ { Default=>0, IEO=>o, Name=>sel_pm_sign_0, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_1, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_2, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_3, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_4, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_5, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_6, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_7, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_8, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_9, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_10, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_11, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_12, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_13, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_14, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_15, Width=>2 }
//	]
//
// BaseAddr (_GENESIS2_INHERITANCE_PRIORITY_) = 0x1500
//
...
//
// REGISTERS
// sel_pm_sign_0 [1:0] IEO=o Offset=0 -- 
// sel_pm_sign_1 [1:0] IEO=o Offset=4 -- 
// sel_pm_sign_2 [1:0] IEO=o Offset=8 -- 
// sel_pm_sign_3 [1:0] IEO=o Offset=12 -- 
// sel_pm_sign_4 [1:0] IEO=o Offset=16 -- 
// sel_pm_sign_5 [1:0] IEO=o Offset=20 -- 
// sel_pm_sign_6 [1:0] IEO=o Offset=24 -- 
// sel_pm_sign_7 [1:0] IEO=o Offset=28 -- 
// sel_pm_sign_8 [1:0] IEO=o Offset=32 -- 
// sel_pm_sign_9 [1:0] IEO=o Offset=36 -- 
// sel_pm_sign_10 [1:0] IEO=o Offset=40 -- 
// sel_pm_sign_11 [1:0] IEO=o Offset=44 -- 
// sel_pm_sign_12 [1:0] IEO=o Offset=48 -- 
// sel_pm_sign_13 [1:0] IEO=o Offset=52 -- 
// sel_pm_sign_14 [1:0] IEO=o Offset=56 -- 
// sel_pm_sign_15 [1:0] IEO=o Offset=60 -- 
...
module reg_file_unq22
  (
   ...
   //outputs
    // outputs for register sel_pm_sign_0
    output wire logic[1:0]       sel_pm_sign_0_q,
                           
    // outputs for register sel_pm_sign_1
    output wire logic[1:0]       sel_pm_sign_1_q,
                           
    // outputs for register sel_pm_sign_2
    output wire logic[1:0]       sel_pm_sign_2_q,
                           
    // outputs for register sel_pm_sign_3
    output wire logic[1:0]       sel_pm_sign_3_q,
                           
    // outputs for register sel_pm_sign_4
    output wire logic[1:0]       sel_pm_sign_4_q,
                           
    // outputs for register sel_pm_sign_5
    output wire logic[1:0]       sel_pm_sign_5_q,
                           
    // outputs for register sel_pm_sign_6
    output wire logic[1:0]       sel_pm_sign_6_q,
                           
    // outputs for register sel_pm_sign_7
    output wire logic[1:0]       sel_pm_sign_7_q,
                           
    // outputs for register sel_pm_sign_8
    output wire logic[1:0]       sel_pm_sign_8_q,
                           
    // outputs for register sel_pm_sign_9
    output wire logic[1:0]       sel_pm_sign_9_q,
                           
    // outputs for register sel_pm_sign_10
    output wire logic[1:0]       sel_pm_sign_10_q,
                           
    // outputs for register sel_pm_sign_11
    output wire logic[1:0]       sel_pm_sign_11_q,
                           
    // outputs for register sel_pm_sign_12
    output wire logic[1:0]       sel_pm_sign_12_q,
                           
    // outputs for register sel_pm_sign_13
    output wire logic[1:0]       sel_pm_sign_13_q,
                           
    // outputs for register sel_pm_sign_14
    output wire logic[1:0]       sel_pm_sign_14_q,
                           
    // outputs for register sel_pm_sign_15
    output wire logic[1:0]       sel_pm_sign_15_q,
   ...
   assign addr_in_range = ((8'h54 == cfgIn_addr_del[13:6]) &&
