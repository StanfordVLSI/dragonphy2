...
//	[ { Default=>27, IEO=>o, Name=>ext_pfd_offset_rep_0, Width=>8 },
//	  { Default=>27, IEO=>o, Name=>ext_pfd_offset_rep_1, Width=>8 }
//	]
//
// BaseAddr (_GENESIS2_INHERITANCE_PRIORITY_) = 0x2a00
//
...
//
// REGISTERS
// ext_pfd_offset_rep_0 [7:0] IEO=o Offset=0 -- 
// ext_pfd_offset_rep_1 [7:0] IEO=o Offset=4 -- 
...
module reg_file_unq43
  (
   ...
   //outputs
    // outputs for register ext_pfd_offset_rep_0
    output wire logic[7:0]       ext_pfd_offset_rep_0_q,
                           
    // outputs for register ext_pfd_offset_rep_1
    output wire logic[7:0]       ext_pfd_offset_rep_1_q,
   ...
   assign addr_in_range = ((11'h540 == cfgIn_addr_del[13:3]) &&
