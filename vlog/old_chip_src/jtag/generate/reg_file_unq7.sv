...
//	[ { IEO=>i, Name=>adcout_avg_0, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_1, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_2, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_3, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_4, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_5, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_6, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_7, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_8, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_9, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_10, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_11, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_12, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_13, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_14, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_15, Width=>8 }
//	]
//
...
//
// REGISTERS
// adcout_avg_0 [7:0] IEO=i Offset=0 -- 
// adcout_avg_1 [7:0] IEO=i Offset=4 -- 
// adcout_avg_2 [7:0] IEO=i Offset=8 -- 
// adcout_avg_3 [7:0] IEO=i Offset=12 -- 
// adcout_avg_4 [7:0] IEO=i Offset=16 -- 
// adcout_avg_5 [7:0] IEO=i Offset=20 -- 
// adcout_avg_6 [7:0] IEO=i Offset=24 -- 
// adcout_avg_7 [7:0] IEO=i Offset=28 -- 
// adcout_avg_8 [7:0] IEO=i Offset=32 -- 
// adcout_avg_9 [7:0] IEO=i Offset=36 -- 
// adcout_avg_10 [7:0] IEO=i Offset=40 -- 
// adcout_avg_11 [7:0] IEO=i Offset=44 -- 
// adcout_avg_12 [7:0] IEO=i Offset=48 -- 
// adcout_avg_13 [7:0] IEO=i Offset=52 -- 
// adcout_avg_14 [7:0] IEO=i Offset=56 -- 
// adcout_avg_15 [7:0] IEO=i Offset=60 -- 
...
//                             MODULE:
// =============================================================================
module reg_file_unq7
  (
   // inputs for the config interface
   cfg_ifc_unq1.cfgIn cfgIn, // incoming requests
   cfg_ifc_unq1.cfgOut cfgOut, // outgoing responds

    // inputs for register adcout_avg_0
    input wire logic [7:0]       adcout_avg_0_d,

    // inputs for register adcout_avg_1
    input wire logic [7:0]       adcout_avg_1_d,

    // inputs for register adcout_avg_2
    input wire logic [7:0]       adcout_avg_2_d,

    // inputs for register adcout_avg_3
    input wire logic [7:0]       adcout_avg_3_d,

    // inputs for register adcout_avg_4
    input wire logic [7:0]       adcout_avg_4_d,

    // inputs for register adcout_avg_5
    input wire logic [7:0]       adcout_avg_5_d,

    // inputs for register adcout_avg_6
    input wire logic [7:0]       adcout_avg_6_d,

    // inputs for register adcout_avg_7
    input wire logic [7:0]       adcout_avg_7_d,

    // inputs for register adcout_avg_8
    input wire logic [7:0]       adcout_avg_8_d,

    // inputs for register adcout_avg_9
    input wire logic [7:0]       adcout_avg_9_d,

    // inputs for register adcout_avg_10
    input wire logic [7:0]       adcout_avg_10_d,

    // inputs for register adcout_avg_11
    input wire logic [7:0]       adcout_avg_11_d,

    // inputs for register adcout_avg_12
    input wire logic [7:0]       adcout_avg_12_d,

    // inputs for register adcout_avg_13
    input wire logic [7:0]       adcout_avg_13_d,

    // inputs for register adcout_avg_14
    input wire logic [7:0]       adcout_avg_14_d,

    // inputs for register adcout_avg_15
    input wire logic [7:0]       adcout_avg_15_d,
   ...
   // ==============================
   // register #0 --- name:adcout_avg_0, type:i, Width:8
