...
//	[ { Default=>0, IEO=>o, Name=>init_0, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_1, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_2, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_3, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_4, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_5, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_6, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_7, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_8, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_9, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_10, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_11, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_12, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_13, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_14, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>init_15, Width=>2 }
//	]
//
// BaseAddr (_GENESIS2_INHERITANCE_PRIORITY_) = 0x1400
//
...
//
// REGISTERS
// init_0 [1:0] IEO=o Offset=0 -- 
// init_1 [1:0] IEO=o Offset=4 -- 
// init_2 [1:0] IEO=o Offset=8 -- 
// init_3 [1:0] IEO=o Offset=12 -- 
// init_4 [1:0] IEO=o Offset=16 -- 
// init_5 [1:0] IEO=o Offset=20 -- 
// init_6 [1:0] IEO=o Offset=24 -- 
// init_7 [1:0] IEO=o Offset=28 -- 
// init_8 [1:0] IEO=o Offset=32 -- 
// init_9 [1:0] IEO=o Offset=36 -- 
// init_10 [1:0] IEO=o Offset=40 -- 
// init_11 [1:0] IEO=o Offset=44 -- 
// init_12 [1:0] IEO=o Offset=48 -- 
// init_13 [1:0] IEO=o Offset=52 -- 
// init_14 [1:0] IEO=o Offset=56 -- 
// init_15 [1:0] IEO=o Offset=60 -- 
...
module reg_file_unq21
  (
   ...
   //outputs
    // outputs for register init_0
    output wire logic[1:0]       init_0_q,
                           
    // outputs for register init_1
    output wire logic[1:0]       init_1_q,
                           
    // outputs for register init_2
    output wire logic[1:0]       init_2_q,
                           
    // outputs for register init_3
    output wire logic[1:0]       init_3_q,
                           
    // outputs for register init_4
    output wire logic[1:0]       init_4_q,
                           
    // outputs for register init_5
    output wire logic[1:0]       init_5_q,
                           
    // outputs for register init_6
    output wire logic[1:0]       init_6_q,
                           
    // outputs for register init_7
    output wire logic[1:0]       init_7_q,
                           
    // outputs for register init_8
    output wire logic[1:0]       init_8_q,
                           
    // outputs for register init_9
    output wire logic[1:0]       init_9_q,
                           
    // outputs for register init_10
    output wire logic[1:0]       init_10_q,
                           
    // outputs for register init_11
    output wire logic[1:0]       init_11_q,
                           
    // outputs for register init_12
    output wire logic[1:0]       init_12_q,
                           
    // outputs for register init_13
    output wire logic[1:0]       init_13_q,
                           
    // outputs for register init_14
    output wire logic[1:0]       init_14_q,
                           
    // outputs for register init_15
    output wire logic[1:0]       init_15_q,
   ...
   assign addr_in_range = ((8'h50 == cfgIn_addr_del[13:6]) &&
