...
//	[ { Default=>0, IEO=>o, Name=>ctl_dcdl_late_rep_0, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_late_rep_1, Width=>2 }
//	]
//
// BaseAddr (_GENESIS2_INHERITANCE_PRIORITY_) = 0x2400
//
...
//
// REGISTERS
// ctl_dcdl_late_rep_0 [1:0] IEO=o Offset=0 -- 
// ctl_dcdl_late_rep_1 [1:0] IEO=o Offset=4 -- 
...
module reg_file_unq37
  (
   ...
   //outputs
    // outputs for register ctl_dcdl_late_rep_0
    output wire logic[1:0]       ctl_dcdl_late_rep_0_q,
                           
    // outputs for register ctl_dcdl_late_rep_1
    output wire logic[1:0]       ctl_dcdl_late_rep_1_q,
   ...
   assign addr_in_range = ((11'h480 == cfgIn_addr_del[13:3]) &&
