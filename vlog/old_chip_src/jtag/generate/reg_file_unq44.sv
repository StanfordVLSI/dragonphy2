...
//	[ { Default=>10, IEO=>o, Name=>ext_max_sel_mux_0, Width=>5 },
//	  { Default=>10, IEO=>o, Name=>ext_max_sel_mux_1, Width=>5 },
//	  { Default=>10, IEO=>o, Name=>ext_max_sel_mux_2, Width=>5 },
//	  { Default=>10, IEO=>o, Name=>ext_max_sel_mux_3, Width=>5 }
//	]
//
// BaseAddr (_GENESIS2_INHERITANCE_PRIORITY_) = 0x2b00
//
...
//
// REGISTERS
// ext_max_sel_mux_0 [4:0] IEO=o Offset=0 -- 
// ext_max_sel_mux_1 [4:0] IEO=o Offset=4 -- 
// ext_max_sel_mux_2 [4:0] IEO=o Offset=8 -- 
// ext_max_sel_mux_3 [4:0] IEO=o Offset=12 -- 
...
module reg_file_unq44
  (
   ...
   //outputs
    // outputs for register ext_max_sel_mux_0
    output wire logic[4:0]       ext_max_sel_mux_0_q,
                           
    // outputs for register ext_max_sel_mux_1
    output wire logic[4:0]       ext_max_sel_mux_1_q,
                           
    // outputs for register ext_max_sel_mux_2
    output wire logic[4:0]       ext_max_sel_mux_2_q,
                           
    // outputs for register ext_max_sel_mux_3
    output wire logic[4:0]       ext_max_sel_mux_3_q,
   ...
   assign addr_in_range = ((10'h2b0 == cfgIn_addr_del[13:4]) &&
