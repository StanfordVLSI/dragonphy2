...
//	[ { Default=>0, IEO=>o, Name=>sel_pm_sign_pi_0, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_pi_1, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_pi_2, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>sel_pm_sign_pi_3, Width=>2 }
//	]
//
...
//
// REGISTERS
// sel_pm_sign_pi_0 [1:0] IEO=o Offset=0 -- 
// sel_pm_sign_pi_1 [1:0] IEO=o Offset=4 -- 
// sel_pm_sign_pi_2 [1:0] IEO=o Offset=8 -- 
// sel_pm_sign_pi_3 [1:0] IEO=o Offset=12 -- 
...
module reg_file_unq28
  (
   ...
   //outputs
    // outputs for register sel_pm_sign_pi_0
    output wire logic[1:0]       sel_pm_sign_pi_0_q,
                           
    // outputs for register sel_pm_sign_pi_1
    output wire logic[1:0]       sel_pm_sign_pi_1_q,
                           
    // outputs for register sel_pm_sign_pi_2
    output wire logic[1:0]       sel_pm_sign_pi_2_q,
                           
    // outputs for register sel_pm_sign_pi_3
    output wire logic[1:0]       sel_pm_sign_pi_3_q,
   ...
   assign addr_in_range = ((10'h1b0 == cfgIn_addr_del[13:4]) &&
