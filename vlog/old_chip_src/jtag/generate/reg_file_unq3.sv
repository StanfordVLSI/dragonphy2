...
//	[ { IEO=>i, Name=>pm_out_pi_0, Width=>20 },
//	  { IEO=>i, Name=>pm_out_pi_1, Width=>20 },
//	  { IEO=>i, Name=>pm_out_pi_2, Width=>20 },
//	  { IEO=>i, Name=>pm_out_pi_3, Width=>20 }
//	]
//
...
//
// REGISTERS
// pm_out_pi_0 [19:0] IEO=i Offset=0 -- 
// pm_out_pi_1 [19:0] IEO=i Offset=4 -- 
// pm_out_pi_2 [19:0] IEO=i Offset=8 -- 
// pm_out_pi_3 [19:0] IEO=i Offset=12 -- 
...
//                             MODULE:
// =============================================================================
module reg_file_unq3
  (
   // inputs for the config interface
   cfg_ifc_unq1.cfgIn cfgIn, // incoming requests
   cfg_ifc_unq1.cfgOut cfgOut, // outgoing responds

    // inputs for register pm_out_pi_0
    input wire logic [19:0]       pm_out_pi_0_d,

    // inputs for register pm_out_pi_1
    input wire logic [19:0]       pm_out_pi_1_d,

    // inputs for register pm_out_pi_2
    input wire logic [19:0]       pm_out_pi_2_d,

    // inputs for register pm_out_pi_3
    input wire logic [19:0]       pm_out_pi_3_d,
   ...
   assign addr_in_range = ((10'h130 == cfgIn_addr_del[13:4]) &&
   ...
   // ==============================
   // register #0 --- name:pm_out_pi_0, type:i, Width:20
