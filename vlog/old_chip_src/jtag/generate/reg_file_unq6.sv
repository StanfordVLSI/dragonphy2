...
//	[ { IEO=>i, Name=>pm_out_rep_0, Width=>20 },
//	  { IEO=>i, Name=>pm_out_rep_1, Width=>20 }
//	]
//
...
//
// REGISTERS
// pm_out_rep_0 [19:0] IEO=i Offset=0 -- 
// pm_out_rep_1 [19:0] IEO=i Offset=4 -- 
...
//                             MODULE:
// =============================================================================
module reg_file_unq6
  (
   // inputs for the config interface
   cfg_ifc_unq1.cfgIn cfgIn, // incoming requests
   cfg_ifc_unq1.cfgOut cfgOut, // outgoing responds

    // inputs for register pm_out_rep_0
    input wire logic [19:0]       pm_out_rep_0_d,

    // inputs for register pm_out_rep_1
    input wire logic [19:0]       pm_out_rep_1_d,
   ...
   assign addr_in_range = ((11'h2c0 == cfgIn_addr_del[13:3]) &&
   ...
   // ==============================
   // register #0 --- name:pm_out_rep_0, type:i, Width:20
