...
//	[ { IEO=>i, Name=>adcout_avg_rep_0, Width=>8 },
//	  { IEO=>i, Name=>adcout_avg_rep_1, Width=>8 }
//	]
//
...
//
// REGISTERS
// adcout_avg_rep_0 [7:0] IEO=i Offset=0 -- 
// adcout_avg_rep_1 [7:0] IEO=i Offset=4 -- 
...
//                             MODULE:
// =============================================================================
module reg_file_unq12
  (
   // inputs for the config interface
   cfg_ifc_unq1.cfgIn cfgIn, // incoming requests
   cfg_ifc_unq1.cfgOut cfgOut, // outgoing responds

    // inputs for register adcout_avg_rep_0
    input wire logic [7:0]       adcout_avg_rep_0_d,

    // inputs for register adcout_avg_rep_1
    input wire logic [7:0]       adcout_avg_rep_1_d,
   ...
   assign addr_in_range = ((11'h380 == cfgIn_addr_del[13:3]) &&
   ...
   // ==============================
   // register #0 --- name:adcout_avg_rep_0, type:i, Width:8
   ...
   assign regs_d[0][7:0] = (onehot_en[0])?cfgIn_data_del[7:0]:
                                                                  adcout_avg_rep_0_d[7:0]; 
   flop_unq10  adcout_avg_rep_0_reg
   ...
   // register #1 --- name:adcout_avg_rep_1, type:i, Width:8
   // flop input with no qualifier
   assign regs_en[1] = 1'b1; 
   // give priority to cfg bus writes, otherwise input from module input
   assign regs_d[1][7:0] = (onehot_en[1])?cfgIn_data_del[7:0]:
                                                                  adcout_avg_rep_1_d[7:0]; 
   flop_unq10  adcout_avg_rep_1_reg
