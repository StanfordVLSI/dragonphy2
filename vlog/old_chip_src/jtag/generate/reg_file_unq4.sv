...
//	[ { IEO=>i, Name=>Qperi_0, Width=>5 },
//	  { IEO=>i, Name=>Qperi_1, Width=>5 },
//	  { IEO=>i, Name=>Qperi_2, Width=>5 },
//	  { IEO=>i, Name=>Qperi_3, Width=>5 }
//	]
//
...
//
// REGISTERS
// Qperi_0 [4:0] IEO=i Offset=0 -- 
// Qperi_1 [4:0] IEO=i Offset=4 -- 
// Qperi_2 [4:0] IEO=i Offset=8 -- 
// Qperi_3 [4:0] IEO=i Offset=12 -- 
...
//                             MODULE:
// =============================================================================
module reg_file_unq4
  (
   // inputs for the config interface
   cfg_ifc_unq1.cfgIn cfgIn, // incoming requests
   cfg_ifc_unq1.cfgOut cfgOut, // outgoing responds

    // inputs for register Qperi_0
    input wire logic [4:0]       Qperi_0_d,

    // inputs for register Qperi_1
    input wire logic [4:0]       Qperi_1_d,

    // inputs for register Qperi_2
    input wire logic [4:0]       Qperi_2_d,

    // inputs for register Qperi_3
    input wire logic [4:0]       Qperi_3_d,
   ...
   assign addr_in_range = ((10'h140 == cfgIn_addr_del[13:4]) &&
   ...
   // ==============================
   // register #0 --- name:Qperi_0, type:i, Width:5
