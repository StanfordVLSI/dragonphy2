...
//	[ { Default=>0, IEO=>o, Name=>ctl_dcdl_slice_0, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_slice_1, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_slice_2, Width=>2 },
//	  { Default=>0, IEO=>o, Name=>ctl_dcdl_slice_3, Width=>2 }
//	]
//
// BaseAddr (_GENESIS2_INHERITANCE_PRIORITY_) = 0x1d00
//
...
//
// REGISTERS
// ctl_dcdl_slice_0 [1:0] IEO=o Offset=0 -- 
// ctl_dcdl_slice_1 [1:0] IEO=o Offset=4 -- 
// ctl_dcdl_slice_2 [1:0] IEO=o Offset=8 -- 
// ctl_dcdl_slice_3 [1:0] IEO=o Offset=12 -- 
...
module reg_file_unq30
  (
   ...
   //outputs
    // outputs for register ctl_dcdl_slice_0
    output wire logic[1:0]       ctl_dcdl_slice_0_q,
                           
    // outputs for register ctl_dcdl_slice_1
    output wire logic[1:0]       ctl_dcdl_slice_1_q,
                           
    // outputs for register ctl_dcdl_slice_2
    output wire logic[1:0]       ctl_dcdl_slice_2_q,
                           
    // outputs for register ctl_dcdl_slice_3
    output wire logic[1:0]       ctl_dcdl_slice_3_q,
   ...
   assign addr_in_range = ((10'h1d0 == cfgIn_addr_del[13:4]) &&
