...
//	[ { IEO=>i, Name=>adcout_hist_side_rep_0, Width=>16 },
//	  { IEO=>i, Name=>adcout_hist_side_rep_1, Width=>16 }
//	]
//
// BaseAddr (_GENESIS2_INHERITANCE_PRIORITY_) = 0x1f00
//
...
//
// REGISTERS
// adcout_hist_side_rep_0 [15:0] IEO=i Offset=0 -- 
// adcout_hist_side_rep_1 [15:0] IEO=i Offset=4 -- 
...
//                             MODULE:
// =============================================================================
module reg_file_unq15
  (
   // inputs for the config interface
   cfg_ifc_unq1.cfgIn cfgIn, // incoming requests
   cfg_ifc_unq1.cfgOut cfgOut, // outgoing responds

    // inputs for register adcout_hist_side_rep_0
    input wire logic [15:0]       adcout_hist_side_rep_0_d,

    // inputs for register adcout_hist_side_rep_1
    input wire logic [15:0]       adcout_hist_side_rep_1_d,
   ...
   assign addr_in_range = ((11'h3e0 == cfgIn_addr_del[13:3]) &&
   ...
   // ==============================
   // register #0 --- name:adcout_hist_side_rep_0, type:i, Width:16
   ...
   assign regs_d[0][15:0] = (onehot_en[0])?cfgIn_data_del[15:0]:
                                                                  adcout_hist_side_rep_0_d[15:0]; 
   flop_unq12  adcout_hist_side_rep_0_reg
   ...
   // register #1 --- name:adcout_hist_side_rep_1, type:i, Width:16
   // flop input with no qualifier
   assign regs_en[1] = 1'b1; 
   // give priority to cfg bus writes, otherwise input from module input
   assign regs_d[1][15:0] = (onehot_en[1])?cfgIn_data_del[15:0]:
                                                                  adcout_hist_side_rep_1_d[15:0]; 
   flop_unq12  adcout_hist_side_rep_1_reg
