...
editAddRoute [expr $origin_term_p_x+$term_pin_offset_x-$term_pin_width/2] [expr $origin_term_p_y+$term_pin_offset_y+18]
editCommitRoute [expr $origin_term_p_x+$term_width-$term_pin_offset_x+$term_pin_width/2] [expr $origin_term_p_y+$term_pin_offset_y+18] 
editAddRoute [expr $origin_term_p_x+$term_pin_offset_x] [expr $origin_term_p_y+$term_pin_offset_y+18]
editCommitRoute [expr $origin_term_p_x+$term_pin_offset_x] [expr $origin_term_p_y+$term_pin_offset_y-30+18] 
editAddRoute [expr $origin_term_p_x+$term_width-$term_pin_offset_x-2] [expr $origin_term_p_y+$term_pin_offset_y+18]
editCommitRoute [expr $origin_term_p_x+$term_width-$term_pin_offset_x-2] [expr $origin_term_p_y+$term_pin_offset_y-30+18] 

setEdit -nets buf1/BTN
editAddRoute [expr $origin_term_n_x+$term_pin_offset_x-$term_pin_width/2] [expr $origin_term_n_y+$term_pin_offset_y+18]
editCommitRoute [expr $origin_term_n_x+$term_width-$term_pin_offset_x+$term_pin_width/2] [expr $origin_term_n_y+$term_pin_offset_y+18] 
editAddRoute [expr $origin_term_n_x+$term_pin_offset_x] [expr $origin_term_n_y+$term_pin_offset_y+18]
editCommitRoute [expr $origin_term_n_x+$term_pin_offset_x] [expr $origin_term_n_y+$term_pin_offset_y+$term_height+30-2*$term_pin_offset_y+18]
editAddRoute [expr $origin_term_n_x+$term_width-$term_pin_offset_x-2] [expr $origin_term_n_y+$term_pin_offset_y+18]
editCommitRoute [expr $origin_term_n_x+$term_width-$term_pin_offset_x-2] [expr $origin_term_n_y+$term_pin_offset_y+$term_height+30-2*$term_pin_offset_y+18]
